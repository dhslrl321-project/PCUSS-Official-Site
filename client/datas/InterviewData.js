export const data = {
  ...
  cardData: {
    cards: [
      { id: 1, label: "보안 컨설팅 전문가 이재랑", src: "/interview/Interview1.JPG" },
      { id: 2, label: "정보보안 담당자 박지훈", src: "/interview/Interview2.JPG" },
      ...
      { id: 6, label: "보안 전문가 윤정호", src: "/interview/Interview6.jpg" },
    ]
  }
};