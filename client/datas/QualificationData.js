...
export const data = {
  ...
  chatLabels: [
    ...
    { id: 4, label: "열정 가득한 자세", active: false },
  ],
  chatData: [
    {
      id: 1,
    ...
    },
    {
      ...
      conversations: [
        ...
        { id: 5, src: "/chat/junior.svg", chatting: "너무 기대돼요 선배님!!", isQuestions: true }]
    },
    {
      id: 3,
      conversations: [
    ...
    },
    {
      id: 4,
      conversations: [
        { id: 1, src: "/chat/junior.svg", chatting: "선배님! 저는 꼭 배재대학교 정보보안학과로 가야겠어요!", isQuestions: true },
        { id: 2, src: "/chat/junior.svg", chatting: "선배님의 말씀을 들으니 벌써부터 제 열정이 넘쳐나요", isQuestions: true },
        { id: 3, src: "/chat/senior.svg", chatting: "아주 좋아요 :) 여기 있는 모두가 당신처럼 열정 넘치는 에너지를 갖고 있습니다!", isQuestions: false },
        { id: 4, src: "/chat/senior.svg", chatting: "함께 정보보안학과에서 미래를 만들어 나가보아요 ㅎㅎ", isQuestions: false },
        { id: 5, src: "/chat/junior.svg", chatting: "벌써 너무 기대돼요! 잘 부탁드립니다!!", isQuestions: true }]
    }
  ]
}
